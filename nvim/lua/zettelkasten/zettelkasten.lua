...
if title then
    ...
    -- local cmd = string.format('/Users/pedro/.asdf/shims/sb new --vim "%s"', title)
    local cmd = string.format('/home/pedro/.local/share/mise/installs/python/3.13.2/bin/sb new --vim "%s"', title)
